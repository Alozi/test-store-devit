...
let lookbookSection = document.querySelector('.lookbook');
let modalLookbook = lookbookSection.querySelectorAll('.modal');
// console.log(modalLookbook);
let btnModalLookbook = lookbookSection.querySelectorAll('.modal-window--button');
console.log(btnModalLookbook);

let spanModalLookbook = lookbookSection.querySelectorAll('.close');
console.log(spanModalLookbook);
// When the user clicks the button, open the modal 
btnModalLookbook.forEach((item) => {
  item.onclick = function() {
    item.querySelector('.modal').classList.add('modal--open');
  }
});

// When the user clicks anywhere outside of the modal, close it
window.onclick = function(event) {
  modalLookbook.forEach((item) => {
